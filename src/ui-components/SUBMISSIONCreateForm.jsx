...
export default function SUBMISSIONCreateForm(props) {
  ...
  const resetStateValues = () => {
    setProblemId(initialValues.problemId);
    setUser(initialValues.user);
    setResponse(initialValues.response);
    setLanguageFeedback(initialValues.languageFeedback);
    setToneFeedback(initialValues.toneFeedback);
    setOverallFeedback(initialValues.overallFeedback);
    setErrors({});
  };
  const validations = {
